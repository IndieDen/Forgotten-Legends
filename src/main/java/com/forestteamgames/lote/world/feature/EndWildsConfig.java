...
public class EndWildsConfig extends BlockPileConfiguration {
   public static final Codec<EndWildsConfig> CODEC = RecordCodecBuilder.create((p_191267_) -> {
      ...
      })).apply(p_191267_, EndWildsConfig::new);
   });
   public final int spreadWidth;
   public final int spreadHeight;

   public EndWildsConfig(BlockStateProvider p_191263_, int p_191264_, int p_191265_) {
      super(p_191263_);
