...
public class HerobrineScytheItem extends SwordItem {
    public HerobrineScytheItem(Tier pTier, int pAttackDamageModifier, float pAttackSpeedModifier, Properties pProperties) {
