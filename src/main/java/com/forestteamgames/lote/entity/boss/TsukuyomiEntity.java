...
public class TsukuyomiEntity extends Monster {

	private final ServerBossEvent bossInfo = new ServerBossEvent(this.getDisplayName(), ServerBossEvent.BossBarColor.RED,
			ServerBossEvent.BossBarOverlay.PROGRESS);	
	
	public TsukuyomiEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(LoteEntities.TSUKUYOMI.get(), world);
	}
	...
	public TsukuyomiEntity(EntityType<TsukuyomiEntity> type, Level world) {
		super(type, world);
		xpReward = 8;
		setNoAi(false);
		this.setItemSlot(EquipmentSlot.MAINHAND, new ItemStack(LoteItems.MASAMUNE.get()));
	}
