...
public class DeathsingerEntity extends Monster {

	private final ServerBossEvent bossInfo = new ServerBossEvent(this.getDisplayName(), ServerBossEvent.BossBarColor.RED,
			ServerBossEvent.BossBarOverlay.PROGRESS);	
	
	public DeathsingerEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(LoteEntities.DEATHSINGER.get(), world);
	}
	...
	public DeathsingerEntity(EntityType<DeathsingerEntity> type, Level world) {
		super(type, world);
		xpReward = 8;
		setNoAi(false);
		this.setItemSlot(EquipmentSlot.MAINHAND, new ItemStack(LoteItems.DEATHSINGER_BROADSWORD.get()));
	}
