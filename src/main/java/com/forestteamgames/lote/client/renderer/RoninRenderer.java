...
public class RoninRenderer extends HumanoidMobRenderer<RoninEntity, HumanoidModel<RoninEntity>> {
	...
	public ResourceLocation getTextureLocation(RoninEntity entity) {
		return new ResourceLocation("lote:textures/entity/ronin.png");
	}
}