...
public class EndNyliumBlock extends Block implements BonemealableBlock {
	   public EndNyliumBlock(BlockBehaviour.Properties p_55057_) {
	      super(p_55057_);
	   }
	   ...
	   public void randomTick(BlockState p_55074_, ServerLevel p_55075_, BlockPos p_55076_, Random p_55077_) {
	      if (!canBeNylium(p_55074_, p_55075_, p_55076_)) {
	         p_55075_.setBlockAndUpdate(p_55076_, Blocks.END_STONE.defaultBlockState());
	      }
